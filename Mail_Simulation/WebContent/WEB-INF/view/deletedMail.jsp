...
<body>
<center><h1><font color="red">=======Deleted Mail========</font></h1><br></center>
<hr>
...
<h3><center><table border='1' colour="black"><tr><th>Sender</th><th>Receiver</th><th>Message</th><th>Subject</th><th>Permanent Deletion</th></tr>
<c:forEach var="dto" items="${list}">
...
<td><center>${dto.getSubject() }</center></td>
 <td><a href="permanentdeleted?id=+${dto.getMid() }+">PermanentDelete</a></td></tr> 
</c:forEach>
</table>
</body>
</html>