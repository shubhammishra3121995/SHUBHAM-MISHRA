...
public class MyController {
	...
	@Autowired
	com.ust.stock.service.MyService ms;
	...
	public ModelAndView logout(HttpServletRequest req) {
		...
		return new ModelAndView("Login","logout","Logout Sucessfull......");
	}
	...
	public ModelAndView allproduct(){
		...
		if(mlist!=null){
		return new ModelAndView("displayproducts","mlist",mlist);
	}else{
		return new ModelAndView("displayproducts","msg","No product avilable");
	}
	}else{
		return new ModelAndView("Login","msg","Login First");
	}
